...
namespace Etheral
{
    public class PlayerHeavyOffensiveStrike : PlayerBaseAbilityState
    {
        int maxDamage = 50;
        ...
        public PlayerHeavyOffensiveStrike(PlayerStateMachine stateMachine, Ability ability) : base(stateMachine, ability)
        {
        }

        public override void Enter()
        {
            // ability = stateMachine.SpellHandler.HeavyOffensiveStrike;
        ...
        void PassAttackBasedDamage()
        {
            ...
            //TODO: confirm we can delete below - consolidated currentDamage in WeaponHandler
            // if (_stateMachine.WeaponInventory.RightEquippedWeapon.TypeOfWeapon is TypeOfWeapon.OneHandWeapon)
            //     _stateMachine.WeaponHandler.Right_1H_WeaponDamage.SettAttackStatDamage(
            //         ability.DirectDamage + (int)totalAccumulatedDamage,
            //         ability.KnockBackForce, ability.KnockDownForce);
            // else
            //     _stateMachine.WeaponHandler.Right_2H_WeaponDamage.SettAttackStatDamage(ability.DirectDamage,
            //         ability.KnockBackForce, ability.KnockDownForce);
        }
