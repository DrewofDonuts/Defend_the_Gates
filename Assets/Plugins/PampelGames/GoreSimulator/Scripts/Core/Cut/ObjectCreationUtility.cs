...
namespace PampelGames.GoreSimulator
{
    public static class ObjectCreationUtility
    {
        ...
        public static GameObject CreateMeshObject(GoreSimulator goreSimulator, Mesh mesh, string name, BoneTag boneTag)
        {
            GameObject newObject;
            if (goreSimulator._globalSettings.poolActive && Application.isPlaying)
            {
