...
namespace PampelGames.GoreSimulator
{
    ...
    public static class MeshCutJobs
    {
        ...
        public static void IndexesSnapshotExplosion(Transform smrTransform, ChunkClass chunkClass, List<Vector3> bakedVertices)
        {
            ...
            chunkClass.mesh.RecalculateNormals();
            chunkClass.mesh.OptimizeReorderVertexBuffer();
            
            chunkClass.mesh = StitchUtility.StitchCutMesh(chunkClass, stitchVerticesList, centerVertices, cutIndexPositions);
        }
        
        public static bool IndexesSnapshotCut(MeshDataClass meshDataClass, MeshNativeDataClass meshNativeDataClass, 
            Mesh bakedMesh, ExecutionCutClass executionCutClass, Mesh mesh, bool baked)
        {
            var cutCenters = new List<Vector3>();
