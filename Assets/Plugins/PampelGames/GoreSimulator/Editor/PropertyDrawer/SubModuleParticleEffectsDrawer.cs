...
namespace PampelGames.GoreSimulator.Editor
{
    ...
    public class SubModuleParticleEffectsDrawer : PropertyDrawer
    {
        ...
        private ListView particleClasses;
        ...
        private VisualElement MakeItem()
        {
            ...
            var positionOffset = new Vector3Field("Offset");
            positionOffset.name = "positionOffset";
            positionOffset.style.marginLeft = 12f;
            ...
            var boneTag = new EnumField("Bone Tag");
            ...
            positionOffset.tooltip = "Offset to the spawn postiion, using local character coordinates.";
            ...
            rotation.tooltip = "Rotation of the spawned object.";
            ...
            boneTag.tooltip = "Apply this effect only on the specified bone tag.";
            ...
            PositionWrapper.Add(positionOffset);
        ...
        private void BindItem(VisualElement item, int index)
        {
            ...
            var positionOffset = PositionWrapper.Q<Vector3Field>("positionOffset");
            ...
            var positionOffsetProperty = listClassProperty.FindPropertyRelative(nameof(SubModuleParticleEffects.ParticleWrapperClass.positionOffset));
            positionOffset.BindProperty(positionOffsetProperty);
            ...
            boneTag.PGSetupBindPropertyRelative(listClassProperty, nameof(SubModuleParticleEffects.ParticleWrapperClass.boneTag));
            ...
            {
                positionOffset.PGDisplayStyleFlex(_subModuleParticleEffects.particleClasses[index].positionExpl == Enums.ParticlePositionExpl.Center);
            ...
            if (_subModuleParticleEffects.addedType != nameof(GoreModuleCut))
            {
                boneTag.style.display = DisplayStyle.None;
            }
