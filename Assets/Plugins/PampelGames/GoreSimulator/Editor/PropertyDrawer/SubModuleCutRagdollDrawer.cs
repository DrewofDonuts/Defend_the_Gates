...
namespace PampelGames.GoreSimulator.Editor
{
    ...
    public class SubModuleCutRagdollDrawer : PropertyDrawer
    {
        ...
        private IntegerField minimumBoneAmount;
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            minimumBoneAmount = new IntegerField("Min. Bones");
            ...
            if (_goreSimulator.GetGoreModule<GoreModuleRagdoll>() is not { } moduleRagdoll)
            {
