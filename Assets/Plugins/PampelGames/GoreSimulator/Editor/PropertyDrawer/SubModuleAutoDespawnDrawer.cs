...
namespace PampelGames.GoreSimulator.Editor
{
    ...
    public class SubModuleAutoDespawnDrawer : PropertyDrawer
    {
        ...
        private FloatField despawnTimer;

        private VisualElement ShrinkWrapper;
        private Toggle shrink;
        private Slider startShrinking;

        private VisualElement MoveWrapper;
        private Toggle move;
        private Vector3Field moveVector;
        private Slider startMoving;
        ...
        public override VisualElement CreatePropertyGUI(SerializedProperty property)
        {
            ...
            ShrinkWrapper = new VisualElement();
            despawnTimer = new FloatField("Despawn Timer");
            shrink = new Toggle("Shrink");
            startShrinking = new Slider();
            MoveWrapper = new VisualElement();
            move = new Toggle("Move");
            moveVector = new Vector3Field();
            startMoving = new Slider();
