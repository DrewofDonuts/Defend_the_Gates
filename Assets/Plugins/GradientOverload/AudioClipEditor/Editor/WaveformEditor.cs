...
namespace AudioClipEditor
{
    public class WaveformEditor : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            selectedAudioClip =
                (AudioClip)EditorGUILayout.ObjectField("Audio Clip", selectedAudioClip, typeof(AudioClip), false);
        ...
        private void ApplyRealTimeAdjustments()
        {
            ...
            AudioProcessingUtils.ApplyFade(modifiedSamples, modifiedSamples.Length, sampleRate, fadeInDuration,
                fadeOutDuration, fadeInCurve, fadeOutCurve);
        ...
        private void DrawWaveform()
        {
            ...
            if (Event.current.type == EventType.Repaint)
            {
                ...
                Handles.DrawSolidRectangleWithOutline(new Rect(rect.x, rect.y, rect.width, rect.height), Handles.color,
                    Color.clear);
        ...
        private void DrawFadeControls()
        {
            ...
            if (!Mathf.Approximately(oldFadeInDuration, fadeInDuration) ||
                !Mathf.Approximately(oldFadeOutDuration, fadeOutDuration))
            {
                madeChanges = true;
            }
        }
        ...
        private void ApplyChanges()
        {
            ...
            AudioClip newClip = AudioClip.Create(selectedAudioClip.name, modifiedSamples.Length / audioClip.channels,
        ...
        {
            AudioClip clip = AudioClip.Create("ModifiedClip", modifiedSamples.Length / audioClip.channels,
                audioClip.channels, sampleRate, false);
